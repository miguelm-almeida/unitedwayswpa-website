...
"[project]/app/get-help/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$proxy$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["renderPage"])({
        path: "get-help",
        transform: (html)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$proxy$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addCtaTrigger"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$proxy$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addIframe"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$proxy$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addBootstrap"])(html), '<div class="card-grid card-grid--icons'))
    });
}
}),
...
function addSearchBar(html, anchor) {
    ...
    const styles = `<style>
.skilly-search{width:min(1400px,calc(100% - 80px));margin:56px auto}
.skilly-search .input-container{width:100%!important;max-width:none!important;min-width:0!important;height:64px!important;padding:0 8px 0 20px!important;border:2px solid #0044b5!important;border-radius:8px!important;flex-direction:row!important;box-sizing:border-box}
.skilly-search .input-container input{flex:1;margin:0!important;font-family:Palanquin,Arial,sans-serif!important;font-size:19px!important;color:#21296b!important;--placeholder-color:#5c6699}
.skilly-search .input-container .send-button{width:48px;height:48px!important;flex:0 0 48px;display:flex;align-items:center;justify-content:center;border-radius:6px;background:#0044b5!important}
.skilly-search .input-container .send-button svg{width:22px;height:22px}
.skilly-search .input-container .send-button svg [fill]{fill:#fff}
.skilly-search .input-container .send-button svg [stroke]{stroke:#fff}
@media(max-width:850px){.skilly-search{width:calc(100% - 40px);margin:36px auto}.skilly-search .input-container{height:56px!important;padding:0 6px 0 14px!important}.skilly-search .input-container input{font-size:16px!important}}
</style>`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0w8szd1._.js.map