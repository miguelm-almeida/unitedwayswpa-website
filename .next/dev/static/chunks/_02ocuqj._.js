...
"[project]/app/SkillyWidget.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SkillyWidget() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SkillyWidget.useEffect": ()=>{
            ...
            let timer;
            const load = {
                "SkillyWidget.useEffect.load": ()=>{
                    document.querySelector("script[data-skilly]")?.remove();
                    const script = document.createElement("script");
                    script.src = WIDGET_SRC;
                    script.async = true;
                    script.dataset.skilly = "true";
                    script.onerror = ({
                        "SkillyWidget.useEffect.load": ()=>{
                            if (attempt++ < 3) timer = setTimeout(load, 1000 * attempt);
                        }
                    })["SkillyWidget.useEffect.load"];
                    document.body.appendChild(script);
                }
            }["SkillyWidget.useEffect.load"];
            if (!document.querySelector("script[data-skilly]")) load();
            return ({
                "SkillyWidget.useEffect": ()=>clearTimeout(timer)
            })["SkillyWidget.useEffect"];
        }
    }["SkillyWidget.useEffect"], []);
    return null;
}
_s(SkillyWidget, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = SkillyWidget;
var _c;
__turbopack_context__.k.register(_c, "SkillyWidget");
...
//# sourceMappingURL=_02ocuqj._.js.map